...
if __name__ == '__main__':
    ...
    with PhyLayer(inventory, workload_network_desc, ansible_ctx, ansible_quiet=True) as phy_layer:
        ...
        with WorkloadNetwork(phy, ansible_ctx, ansible_quiet=True) as workload_net:
